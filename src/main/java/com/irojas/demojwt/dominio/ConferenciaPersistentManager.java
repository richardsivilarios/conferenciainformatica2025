...
public class ConferenciaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Conferencia";
	...
	private ConferenciaPersistentManager() throws PersistentException {
	...
	protected void configureMetadataSources(MetadataSources aMetadataSources) {
		...
		aMetadataSources.addAnnotatedClass(com.irojas.demojwt.dominio.Vcategoriaproducto.class);
		aMetadataSources.addAnnotatedClass(com.irojas.demojwt.dominio.Categories.class);
		aMetadataSources.addAnnotatedClass(com.irojas.demojwt.dominio.Products.class);
		aMetadataSources.addAnnotatedClass(com.irojas.demojwt.dominio.Suppliers.class);
	}
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ConferenciaPersistentManager();
		}
